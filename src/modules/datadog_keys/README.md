...
| Name | Description |
|------|-------------|
| <a name="output_api_key_ssm_arn"></a> [api\_key\_ssm\_arn](#output\_api\_key\_ssm\_arn) | Datadog API Key SSM ARN |
...
| <a name="output_datadog_api_url"></a> [datadog\_api\_url](#output\_datadog\_api\_url) | Datadog API URL |
| <a name="output_datadog_app_key"></a> [datadog\_app\_key](#output\_datadog\_app\_key) | Datadog APP Key |
