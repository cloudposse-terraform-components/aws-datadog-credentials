...
| <a name="module_iam_roles_datadog_secrets"></a> [iam\_roles\_datadog\_secrets](#module\_iam\_roles\_datadog\_secrets) | github.com/cloudposse-terraform-components/aws-account-map//src/modules/iam-roles | v1.536.0 |
